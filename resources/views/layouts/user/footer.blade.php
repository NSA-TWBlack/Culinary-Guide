...
<footer class="container-fluid text-center text-lg-start bg-white text-muted">
        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 text-center">
                    <!-- logo -->
                    <img src="https://lh3.googleusercontent.com/pw/AL9nZEUbbX7M-v77e7-pA0CTifccsWHEe8LUmRXrKQ-gOuVpaobyW1bMXcQEadLpfXZGQ0fwFCqB32h8h8zgNMOahJIN1IGWoxKnGiSd6QCqtYuZqVllMb6OVvGTYxrfJ0AZfOqi3_zB0LrhVb9eFtnwBsuE=s450-no?authuser=0" alt="" style="max-width: 150px">
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 text-left">
                    ...
                    <p>
                        <a href="{{ route('user.feedback') }}" class="text-reset">Góp ý</a>
                    </p>
                    <p>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
        © 2022 Copyright:
        <a class="text-reset fw-bold p-0" href="https://lh3.googleusercontent.com/pw/AL9nZEUbbX7M-v77e7-pA0CTifccsWHEe8LUmRXrKQ-gOuVpaobyW1bMXcQEadLpfXZGQ0fwFCqB32h8h8zgNMOahJIN1IGWoxKnGiSd6QCqtYuZqVllMb6OVvGTYxrfJ0AZfOqi3_zB0LrhVb9eFtnwBsuE=s450-no?authuser=0">Cẩm nang ẩm thực</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->