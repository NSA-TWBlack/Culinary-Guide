        ...
        <div class="collapse navbar-collapse justify-content-around" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                @if ($name != 'Tm9uZQ==')
                    {{-- <li class="hidden nav-item px-3">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="background-color: rgba(0, 0, 0, 0.816)">
                                ...
                                @if ($typeuser == 1)
                                    <li>
                                        <a class="dropdown-item text-warning" href="{{ route('profile.edit') }}">Thông
                                            tin tài khoản</a>
                                    </li>
                                @endif
                    ...
                    <li class="hidden nav-item px-3 sm:flex sm:items-center">
                        <x-dropdown>
                            <x-slot name="trigger">
                                <a class="nav-link" style="cursor: pointer">
                                    <i class="far fa-user-circle"></i>
                                    <i class="fas fa-chevron-down fs-13"></i>
                                </a>
                            </x-slot>
                            <x-slot name="content">
