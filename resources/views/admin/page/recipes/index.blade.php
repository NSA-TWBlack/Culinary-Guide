...
@section('content')
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.recipes.index') }}">Công thức ẩm thực</a></li>
        </ul>
    </div>
    <div class="d-flex justify-content-center">
        <p class="d-grid gap-2 col-2 mx-auto">
            <a class="btn btn-outline-info " href="{{ route('admin.recipes.create') }}"><i class="fa fa-plus"
                            ...
                            @foreach ($recipes as $key)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('recipes.detail', $key['id']) }}"
                                            class="btn btn-outline-info btn-sm">
                                            <i class="fa fa-eye m-0" aria-hidden="true"></i>
                                        </a>
                                        <a href="{{ route('admin.recipes.edit', $key['id']) }}"
                                            class="btn btn-outline-warning btn-sm">
                                            <i class="fa fa-pencil m-0" aria-hidden="true"></i>
                                        </a>
                                        <a href="{{ route('admin.recipes.destroy', $key['id']) }}"
