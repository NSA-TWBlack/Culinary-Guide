...
@section('title')
    <title>Chỉnh sửa công thức</title>
@endsection
<!-- active nav-link -->
<style>
...
@section('content')
    ...
    <form action="{{ route('admin.recipes.update', $recipes['id']) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            <div class="p-3 col-xl-7 col-lg-7 col-md-12">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input placeholder="Tên công thức ..." type="text" id="title" name="txtTitle"
                                        class="form-control rounded-0" value="{{ $recipes['title'] }}">
                                </div>
                                @error('txtTitle')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="txtCategories" id="categories" class="form-select rounded-0">
                                        ...
                                        @foreach ($categories as $value)
                                            @if ($recipes['id_categories'] == $value['id'])
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea placeholder="Mô tả về công thức ..." name="txtDescription" id="description" class="form-control rounded-0">{{ $recipes['description'] }}</textarea>
                                </div>
                                <!-- ingredients -->
                                <div class="form-group mb-3">
                            ...
                            <div class="p-3 col-xl-5 col-lg-5 col-md-12 pt-5">
                                ...
                                <input type="file" name="imageUpload" id="imageUpload" class="dis-none" accept="image/*"
                                    onchange="handleChange()" value="{{ $recipes['image'] }}">
