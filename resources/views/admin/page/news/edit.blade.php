                            ...
                            <div class="p-3 col-xl-7 col-lg-7 col-md-12">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input placeholder="Tiêu đề tin tức" type="text" id="title" name="txtTitle"
                                        value="{{ $news['title'] }} " class="form-control rounded-0">
                                </div>
                                @error('txtTitle')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea placeholder="Mô tả về công thức ..." name="txtDescription" id="description" class="form-control rounded-0"> {{ $news['description'] }} </textarea>
                                </div>
