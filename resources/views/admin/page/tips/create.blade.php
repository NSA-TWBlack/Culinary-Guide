                        ...
                        <div class="row">
                            <div class="p-3 col-xl-7 col-lg-7 col-md-12">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input placeholder="Tên mẹo vặt..." type="text" id="title" name="txtTitle"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea placeholder="Mô tả về mẹo vặt ..." name="txtDescription" id="description" class="form-control rounded-0"></textarea>
                                </div>
